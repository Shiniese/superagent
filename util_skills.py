"""
Source: https://github.com/langchain-ai/deepagents/blob/master/libs/deepagents-cli/deepagents_cli/skills/load.py
...
from config import CUSTOM_SKILLS
...
def list_skills(
    *, user_skills_dir: Path | None = None, project_skills_dir: Path | None = None
    ...
    """
    all_skills: dict[str, SkillMetadata] = CUSTOM_SKILLS
...
if __name__ == "__main__":
    print(list_skills(user_skills_dir=Path('./skills')))
